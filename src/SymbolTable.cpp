...
void SymbolTable::reset_local_offset() {
...
bool SymbolTable::declareFunction(const std::string& name, const Type& return_type,
...
int SymbolTable::getMaxStackSize() const {
